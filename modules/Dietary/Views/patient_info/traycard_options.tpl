...
<script>
  $(document).ready(function() {
    $("#traycard").submit(function(e) {
      ...
      window.location = SITE_URL + "/?module=Dietary&page=patient_info&action=meal_tray_card&patient={$patient->public_id}&location={$location->public_id}&date=" + date + "&meal_id=" + $("#meal-id option:selected").val() + "&pdf=true";
    });
  });
</script>
