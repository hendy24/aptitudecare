...
(function( $ ){
	jQuery.sessionTimeout = function( options ) {
		var defaults = {
			...
			keepAliveUrl : SITE_URL + '/?page=login&action=keepalive',
			redirUrl     : SITE_URL + '/?page=login&action=timeout',
			logoutUrl    : SITE_URL + '/?page=login&action=logout',
			warnAfter    : 15000, // 15 minutes
			redirAfter   : 30000 // 20 minutes
		};
