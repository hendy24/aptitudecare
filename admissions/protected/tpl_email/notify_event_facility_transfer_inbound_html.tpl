...
<tr>
	<td width="100%" style="padding: 10px 0 10px 20px;">
        ...
        This message has been generated to notify you of a scheduled transfer of a patient from another AHC facility to yours. The transfer by scheduled by {$trigger_user->getFullName()}.<br />
		<br />
