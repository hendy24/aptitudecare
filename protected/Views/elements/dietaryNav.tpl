<li id="current-residents" class="nav-item">
	<a href="{$SITE_URL}?module=Dietary&amp;page=dietary&amp;action=index&amp;location={$location->public_id}" class="nav-link"><i class="fas fa-user-friends"></i> Current Residents</a>
</li>
	...
	<div class="collapse" id="infoSection" data-parent="#sidebar-nav">
		<ul class="nav flex-column ml-4">
			<li id="current-menu" class="nav-item">
				<a class="nav-link" href="{$SITE_URL}?module={$this->getModule()}&amp;page=info&amp;action=current&amp;location={$location->public_id}"><i class="fab fa-elementor"></i> Current Menu</a>
			</li>
			<li id="menu-start-date" class="nav-item">
				<a class="nav-link" href="{$SITE_URL}?module={$this->getModule()}&amp;page=info&amp;action=menu_start_date&amp;location={$location->public_id}"><i class="fas fa-calendar-day"></i> Menu Start Date</a>
			</li>
			<li id="public-page-items" class="nav-item">
				<a class="nav-link" href="{$SITE_URL}?module={$this->getModule()}&amp;page=info&amp;action=public_page_items&amp;location={$location->public_id}"><i class="fas fa-sitemap"></i> Public Page Items</a>
			</li>
			<!-- <li class="nav-item">
			...
			<li class="nav-item">
				<a class="nav-link" href="{$SITE_URL}?page=public-display&amp;location={$location->public_id}" target="_blank"><i class="fas fa-eye"></i> Preview Public Page</a>
			</li>


			{if $auth->hasPermission("create_menu")}
			<li id="create-menu" class="nav-item">
				<a class="nav-link" href="{$SITE_URL}?module={$this->getModule()}&amp;page=info&amp;action=create"><i class="far fa-calendar-plus"></i> Create Menu</a>
			</li>
			<li id="manage-menus" class="nav-item">
				<a class="nav-link" href="{$SITE_URL}/?module={$this->getModule()}&amp;page=info&amp;action=manage"><i class="fas fa-tasks"></i> Manage Menus</a>
			</li>
			<!-- <li class="nav-item">
			...
			<li id="corporate-menus" class="nav-item">
				<a class="nav-link" href="{$SITE_URL}?module={$this->getModule()}&amp;page=info&amp;action=corporate_menus"><i class="fas fa-copy"></i> Corporate Menus</a>
			</li>
			{/if}
		</ul>
	</div>
	...
	<div class="collapse" id="reportsSection" data-parent="#sidebar-nav">
		<ul class="nav flex-column ml-4">
			...
			<li id="diet-census" class="nav-item">
				<a class="nav-link" href="{$SITE_URL}?module={$this->getModule()}&amp;page=reports&amp;action=diet_census&amp;location={$location->public_id}"><i class="fas fa-utensils"></i> Diet Census</a>
			</li>
			<!-- <li class="nav-item">
			...
			<li id="weekly-menu" class="nav-item">
				<a class="nav-link" href="{$SITE_URL}?module={$this->getModule()}&amp;page=menu&amp;action=print_menu&amp;location={$location->public_id}&amp;pdf=true" target="_blank"><i class="fas fa-calendar-week"></i> Weekly Menu</a>
			</li>
			{if $auth->hasPermission("create_menu")}
			<li id="menu-changes" class="nav-item">
				<a class="nav-link" href="{$SITE_URL}?module={$this->getModule()}&amp;page=reports&amp;action=menu_changes"><i class="fab fa-stack-exchange"></i> Menu Changes</a>
			</li>
			{/if}
		</ul>
	</div>
