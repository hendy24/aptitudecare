...
class DietaryMenuHelper {
	...
	public function menu($patient, $selectedLocation) {
		...
		$options .= "<li><a href=\"/?module=Dietary&amp;page=patient_info&amp;action=meal_tray_card&amp;patient={$patient->public_id}&amp;location={$selectedLocation->public_id}&amp;pdf=true\" target=\"_blank\">Current Tray Card</a></li>";
		$options .= "<li><a href=\"/?module=Dietary&amp;page=patient_info&amp;action=traycard_options&amp;patient={$patient->public_id}&amp;location={$selectedLocation->public_id}\" target=\"blank\">Selected Tray Card</a></li>";
