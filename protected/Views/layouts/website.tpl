                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="{$SITE_URL}"><img src="{$IMAGES}/home.png" alt="home-menu"></a>
                        </li>
          ...
          <div class="footer_row1">  
            <div class="d-flex">
              ...
              <div class="social-media">
                  <a href="https://www.facebook.com/aspencreekalaska" target="_blank"><i class="fab fa-facebook fa-2x"></i></a>
                  <a href="https://www.instagram.com/aspencreekalaska/" target="_blank"><i class="fab fa-instagram fa-2x"></i></a>
                  <a href="https://www.youtube.com/channel/UCeYE9V77h4y_NcM2EpjhvFQ?view_as=subscriber" target="_blank"><i class="fab fa-youtube fa-2x"></i></a>
                  <a href="https://vimeo.com/user100366085"><i class="fab fa-vimeo fa-2x"></i></a>
              </div>
            </div>
          </div>
...
<!--              <div class="col-md-4">
                  ...
                  <div class="col-md-3">
                    <h4><a href="{$SITE_URL}/living-at-aspen-creek">Living at Aspen Creek</a></h4>
                  </div>
<!--                   <div class="col-md-2">
                    <h4><a href="news">NEWS</a></h4>
                  </div>                  
 -->                  <div class="col-md-2">
                    <h4><a href="{$SITE_URL}/faq">FAQ</a></h4>
                  </div>  
                   <div class="col-md-3">
                    <h4><a href="{$SITE_URL}/contact">Contact</a></h4>
                  </div>                  
                  <div class="col-md-2">
                    <h4><a href="{$SITE_URL}/careers">Careers</a></h4>
                  </div>
                  <div class="col-md-2">
