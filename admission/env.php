...
$site_name = basename(dirname(__DIR__));
...
if ($directory == 'Sites') { // then this is a local directory
	if (file_exists(APP_DIR . DS . ".development")) {
		...
		// set local paths
		define('ENGINE_PROTECTED_PATH', '/Users/kemish/Sites/aptitudecare/admission/cms2/protected');
		define('ENGINE_PUBLIC_PATH', '/Users/kemish/Sites/aptitudecare/admission/cms2/public');
		...
		// set urls
		$ENGINE_URL = "https://aptitudecare.dev/cms2-public";
		$SITE_URL = "https://aptitudecare.dev/admission/";
		$HOMEHEALTH_URL = "https://aptitudecare.dev";
