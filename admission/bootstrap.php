...
if (!defined('APP_DIR')) {
	define(APP_DIR, dirname(dirname(__FILE__)) . DS . 'app');
}

// define the framework directory
if (!defined('FRAMEWORK_DIR')) {
	define(FRAMEWORK_DIR, dirname(dirname(__FILE__)) . DS . 'framework');
}


// define the admission directory
if (!defined('ADMIT_DIR')) {
	define(ADMIT_DIR, dirname(dirname(__FILE__)) . DS . 'admission');
}


require_once ADMIT_DIR . DS . 'env.php';
define(TEST_EMAIL, '');
