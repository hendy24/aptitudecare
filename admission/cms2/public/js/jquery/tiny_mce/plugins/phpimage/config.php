...
// 2010-10-01 - bjc 
$server_image_directory = dirname(__FILE__) . "/../../../../../image_cache/_tinymce_phpimage/" . $_SERVER["SERVER_NAME"];
if (! file_exists($server_image_directory)) {
	$_old = umask(0);
	@mkdir($server_image_directory, 0777, true);
	umask($_old);
}
...
$url_image_directory = '/cms2-public/image_cache/_tinymce_phpimage/' . $_SERVER["SERVER_NAME"];
